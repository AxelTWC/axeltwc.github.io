    ...
    {/* Statement Section */}
      <section id="statement" className="statement reveal">
        ...
        <p>
          ...
          <br></br><br></br>
          Over the years with one of my relatives working in cutting edge tech and after reading and watching the possibilities of where I could reach myself for, I found out the excitement and imminent advancement of AI aiding the world. Since my emphasis on my Master’s Degree is under Data Analyst and Machine Learning, I view myself as a <b>engineer-doctor-nurse for AI/Machines and hope to either take on roles in training (nurturing machines) or AGI robotics.</b> 
          <br></br><br></br>
